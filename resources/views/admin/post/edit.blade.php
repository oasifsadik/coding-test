            ...
            <div class="form shadow p-4 rounded mt-3 ">
                <form action="{{ url('/admin/update',$post->id) }}" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="title" value="{{$post->title}}" placeholder="Enter Your title">
                            @error('title')
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="description" id="" cols="30" rows="5">{{$post->description}}</textarea>
                            @error('description')
                              <div class="text-danger">{{ $message }}</div>
                            @enderror
                    </div>
